                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/profile/'.$user->id) }}">
                        ...
                        <div class="form-group{{ $errors->has('profilepic') ? ' has-error' : '' }}">
                            <label for="profilepic" class="col-md-4 control-label">Profile Pic</label>

                            <div class="col-md-6">
                                <input id="profilepic" type="file" class="form-control" name="profilepic" value="{{ $user->profilepic }}">
